...
OBJS = $(PLUGIN).o i18n.o mg_valmap.o mg_db.o mg_db_gd.o mg_thread_sync.o mg_order.o \
	mg_item.o mg_listitem.o mg_selection.o vdr_actions.o vdr_menu.o mg_tools.o \
...
mugglei: mg_tools.o mugglei.o mg_db.o mg_db_gd.o mg_listitem.o mg_item.o mg_valmap.o mg_order.o mg_setup.o 
