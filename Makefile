...
OBJS = $(PLUGIN).o i18n.o mg_valmap.o mg_db.o mg_db_gd.o mg_thread_sync.o \
...
mugglei: mg_tools.o mugglei.o mg_db.o mg_db_gd.o mg_listitem.o mg_item.o mg_item_gd.o mg_valmap.o mg_setup.o 
